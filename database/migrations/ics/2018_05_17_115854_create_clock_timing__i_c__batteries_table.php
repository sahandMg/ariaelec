...
class CreateClockTimingICBatteriesTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('clock_timing__ic__batteries', function (Blueprint $table) {
            $table->increments('id');
            for($i=0;$i<count($this->cols);$i++){
                $table->string($this->cols[$i])->nullable();
            }
            $table->unsignedInteger('common_id')->default(6);
    ...
    {
        Schema::dropIfExists('clock_timing__ic__batteries');
    }
}
