...
class CreatePMICThermalManagementsTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('pmic__thermal__managements', function (Blueprint $table) {
            $table->increments('id');
            for($i=0;$i<count($this->cols);$i++){
                $table->string($this->cols[$i])->nullable();
            }
            $table->unsignedInteger('common_id')->default(92);
    ...
    {
        Schema::dropIfExists('pmic__thermal__managements');
    }
}
