...
class CreateInterfaceModulesTable extends Migration
{
    public $cols = [];
    /**
     * Run the migrations.
    ...
    public function up()
    {
        ...
        Schema::create('interface__modules', function (Blueprint $table) {
            $table->increments('id');
            for($i=0;$i<count($this->cols);$i++){
                $table->string($this->cols[$i])->nullable();
            }
            $table->unsignedInteger('common_id')->default(35);
    ...
    {
        Schema::dropIfExists('interface__modules');
    }
}
