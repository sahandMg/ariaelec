...
class CreateInterfaceDirectDigitalSynthesisDDSTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('interface__direct__digital__synthesis__dds', function (Blueprint $table) {
            $table->increments('id');
            for($i=0;$i<count($this->cols);$i++){
                $table->string($this->cols[$i])->nullable();
            }
            $table->unsignedInteger('common_id')->default(29);
    ...
    {
        Schema::dropIfExists('interface__direct__digital__synthesis__dds');
    }
}
