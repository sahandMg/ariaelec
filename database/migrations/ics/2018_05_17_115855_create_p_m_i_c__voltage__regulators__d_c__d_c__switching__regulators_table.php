...
class CreatePMICVoltageRegulatorsDCDCSwitchingRegulatorsTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('pmic__voltage__regulators__dc__dc__switching__regulators', function (Blueprint $table) {
            $table->increments('id');
            for($i=0;$i<count($this->cols);$i++){
                $table->string($this->cols[$i])->nullable();
            }
            $table->unsignedInteger('common_id')->default(96);
    ...
    {
        Schema::dropIfExists('pmic__voltage__regulators__dc__dc__switching__regulators');
    }
}
