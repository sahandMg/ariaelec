...
class CreatePMICPowerManagementSpecializedsTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('pmic__power__management__specializeds', function (Blueprint $table) {
            $table->increments('id');
            for($i=0;$i<count($this->cols);$i++){
                $table->string($this->cols[$i])->nullable();
            }
            $table->unsignedInteger('common_id')->default(87);
    ...
    {
        Schema::dropIfExists('pmic__power__management__specializeds');
    }
}
