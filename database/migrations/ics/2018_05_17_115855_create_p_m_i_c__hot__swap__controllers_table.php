...
class CreatePMICHotSwapControllersTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('pmic__hot__swap__controllers', function (Blueprint $table) {
            $table->increments('id');
            for($i=0;$i<count($this->cols);$i++){
                $table->string($this->cols[$i])->nullable();
            }
            $table->unsignedInteger('common_id')->default(79);
    ...
    {
        Schema::dropIfExists('pmic__hot__swap__controllers');
    }
}
